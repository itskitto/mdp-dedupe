"""Script to train the deduplication model."""
import logging
from pathlib import Path
import pandas as pd

from mdp_dedupe.config import Config
from mdp_dedupe.core.dedup_match import deduplicate_records, setup_dedupe, prepare_dedupe_data
...
def main():
    ...
    # Train or load model
    logger.info("Setting up dedupe model...")
