...
def seed_duplicates(session: Session, model, pool: List[Dict], num_duplicates: int, randomize_fields=None):
    ...
    :param model: SQLAlchemy model to seed.
    :param pool: Shared pool of patient data.
    :param num_duplicates: Number of duplicates to insert.
    :param randomize_fields: Fields to slightly vary for duplicates.
    """
...
def seed_unique_records(session: Session, model, num_unique: int):
    ...
    :param session: SQLAlchemy session.
    :param model: SQLAlchemy model to seed.
    :param num_unique: Number of unique records to insert.
    """
...
def adjust_fields_for_model(data: Dict, model):
    ...
    :param data: Shared data dictionary.
    :param model: SQLAlchemy model.
    :return: Adjusted dictionary matching the model's fields.
    """
...
def seed_table(session: Session, model, pool: List[Dict], num_duplicates: int, num_unique: int, randomize_fields=None):
    ...
    :param model: SQLAlchemy model to seed.
    :param pool: Shared pool of patient data.
    :param num_duplicates: Number of duplicate records to insert.
    :param num_unique: Number of unique records to insert.
    :param randomize_fields: Fields to slightly vary for duplicates.
    """
...
def seed_all_tables(shared_pool: List[Dict], duplicates_per_table: int, unique_per_table: int):
    ...
    :param shared_pool: Shared pool of patient data.
    :param duplicates_per_table: Number of duplicates to insert in each table.
    :param unique_per_table: Number of unique records to insert in each table.
    """
    tables = {
        ClinicPatient: ["email"],
